  ...
  "how-it-works": {
    layers: [
      ...
      },
      {
        name: "Скрытый слой",
        description:
          "Скрытые слои находятся между входным и выходным слоями и выполняют сложные вычисления, позволяя сети учиться на основе входных данных. Они отвечают за преобразование входных данных в формат, который может быть использован выходным слоем для получения результата. Скрытые слои могут содержать один или несколько нейронов, которые анализируют входные данные и применяют к ним веса, чтобы определить важность различных аспектов входных данных.",
      },
      {
        name: "Выходной слой",
        description:
          "Это последний слой, который производит предсказания или выходные данные на основе обученных представлений из скрытых слоев. Выходной слой комбинирует информацию, полученную от скрытых слоев, и представляет конечный результат.",
      },
    ],
  },
};
